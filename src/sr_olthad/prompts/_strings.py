"""String constants commonly reused in prompt declarations."""
...
_example_olthad = TaskNode(
    ...
    _non_planned_subtasks=[
        TaskNode(
            ...
            _retrospective="Accomplished by doing X, Y, and Z.",
        ),
        TaskNode(
            _id="1.2",
            _parent_id="1",
            ...
            _retrospective="Wasn't worth pursuing further in light of A, B, and C.",
        ),
        TaskNode(
            _id="1.3",
            _parent_id="1",

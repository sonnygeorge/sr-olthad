...
# Install software-properties-common to add PPAs and curl for uv
...
# Install netcat-openbsd for network utilities
...
RUN curl -LsSf https://astral.sh/uv/install.sh | sh && \
    ...
    cat /uv_location.txt && \
    # Create symlink to a known location
...
# Install Python dependencies using the symlinked uv
